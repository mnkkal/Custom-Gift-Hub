...
export const SITE_NAME = process.env.NEXT_PUBLIC_SITE_NAME || 'Custom Gift Hub ~ By Chaturmal & Co.';
export const SITE_TAGLINE = process.env.NEXT_PUBLIC_SITE_TAGLINE || 'Think gift, Think us!';
